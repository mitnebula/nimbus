...
nimbus --log debug --mode sender --ip $MAHIMAHI_BASE --port 42424 --t 3m --useSwitching=f --initMode XTCP --estBandwidth $2e6 --initRate $4e6 --numFlows 1 --pulseSize $3 --measurementInterval 10ms --measurementTimescale $5 > "$1-poisson.out" &

sleep 2
#~/empirical-traffic-gen/bin/client -c trafficConfig > trafficGen.out &
echo "tgen 1"
trafficgen --mode sender --ip $MAHIMAHI_BASE --port 42426 --initRate 40e6 --t 3m --msgSizeBytes 10220 > $1-t1.out &
#sleep 5
#echo "tgen 2"
